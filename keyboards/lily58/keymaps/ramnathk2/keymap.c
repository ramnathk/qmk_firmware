...
// this is the handsdown ALT layout
    [_HNDALT] = LAYOUT( \
 //,-----------------------------------------------------.                     ,-----------------------------------------------------.
     _______, _______, _______, _______, _______, _______,                      _______, _______, _______, _______, _______, _______,\
 //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
     _______,    KC_W,    KC_G,    KC_H,    KC_M,    KC_V,                          KC_Z,    KC_C,    KC_U,    KC_J, KC_QUOT, _______,\
 //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
     _______,   GUI_R,   ALT_S,  CTRL_N,  SHFT_T,    KC_F,                          KC_Y,  SHFT_A,  CTRL_E,   ALT_O,    KC_I, _______,\
 //|--------+--------+--------+--------+--------+--------+---------.  ,--------+--------+--------+--------+--------+--------+--------|
     _______,    KC_X,    KC_B,    KC_L,    KC_D,    KC_K,  _______,    _______,    KC_Q,    KC_P,  KC_DOT,AGR_COMM, KC_SLSH, _______,\
 //`--------------------------+--------+--------+--------+---------|  |--------+--------+--------+--------+--------+-----------------'
 ...
 //|--------+--------+--------+--------+--------+--------|                      |--------+--------+--------+--------+--------+--------|
     _______,   GUI_A,   ALT_R,  CTRL_S,  SHFT_T,    KC_G,                           KC_M,  SHFT_N,  CTRL_E,   ALT_I,   GUI_O, KC_SCLN,\
 //|--------+--------+--------+--------+--------+--------+---------.  ,---------+--------+--------+--------+--------+--------+--------|
     _______,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,  _______,    _______,     KC_K,    KC_H, KC_COMM, AGR_DOT, KC_SLSH, SFT_ENT,\
 //`--------------------------+--------+--------+--------+---------|  |--------+---------+--------+---------+--------------------------'
                                 _______, MED_ESC, NAV_SPC, KC_TAB,    SYM_ENT,  NUM_BSC,  FN_DEL, _______ \
                            //`------------------------------------'  `------------------------------------'
    ),
...
void oled_task_user(void) {
    ...
    if (timer_elapsed(anim_timer) > FRAME_TIMEOUT) {
        ...
        // animation goes here render_anim();
        // oled_set_cursor(7,6);
            sprintf(wpm_str, "LS:\n%03d", get_highest_layer(layer_state));
...
/* not needed as i dont have a game layer
#ifdef AUTO_SHIFT_ENABLE
