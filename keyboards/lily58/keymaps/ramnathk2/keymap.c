...
// this is based on the handsdown ALT layout. 
 ...
 //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
     _______,   KC_G ,    KC_W,    KC_H,    KC_M,    KC_K,                          KC_Z,    KC_C,    KC_U,    KC_J, KC_QUOT, _______,\
 //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
     _______,   GUI_R,   ALT_S,  CTRL_N,  SHFT_T,    KC_F,                          KC_Y,  SHFT_A,  CTRL_E,   ALT_O,   GUI_I, _______,\
 //|--------+--------+--------+--------+--------+--------+---------.  ,--------+--------+--------+--------+--------+--------+--------|
     _______,    KC_X,    KC_B,    KC_L,    KC_D,    KC_V,  _______,    _______,    KC_Q,    KC_P,  KC_DOT,AGR_COMM,  KC_SLSH, _______,\
 //`--------------------------+--------+--------+--------+---------|  |--------+--------+--------+--------+--------+-----------------'
