...
// this is the handsdown ALT layout
 ...
 //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
     _______, KC_QUOT,    KC_G,    KC_H,    KC_M,    KC_Z,                          KC_V,    KC_P,    KC_O,    KC_X, _______, _______,\
 //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
     _______,   GUI_R,   ALT_S,  CTRL_N,  SHFT_T,    KC_F,                          KC_Y,  SHFT_U,  CTRL_E,   ALT_A,    KC_I, _______,\
 //|--------+--------+--------+--------+--------+--------+---------.  ,--------+--------+--------+--------+--------+--------+--------|
     _______,    KC_J,    KC_B,    KC_L,    KC_D,    KC_K,  _______,    _______,    KC_W,    KC_C,    KC_Q,AGR_COMM,  KC_DOT, _______,\
 //`--------------------------+--------+--------+--------+---------|  |--------+--------+--------+--------+--------+-----------------'
