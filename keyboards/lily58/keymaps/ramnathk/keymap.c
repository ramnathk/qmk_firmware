...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //|--------+--------+--------+--------+--------+--------|                      |--------+--------+--------+--------+---------+--------|
     kOptSht,   GUI_A,   ALT_S,  CTRL_D,  SHFT_F,    KC_G,                           KC_H,  SHFT_J,  CTRL_K,   ALT_L, GUI_QUOT, _______,\
 //|--------+--------+--------+--------+--------+--------+---------.  ,---------+--------+--------+--------+--------+---------+--------|
 kCmdCtrlSft,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  _______,    _______,     KC_N,    KC_M, KC_COMM, AGR_DOT,  KC_SLSH, _______,\
 //`--------------------------+--------+--------+--------+---------|  |--------+---------+--------+--------+---------------------------'
                               mDblCtrl,  KC_ESC, NAV_SPC, KC_TAB,      SYM_ENT,  NAV_BSC,  FN_DEL, TT(_NAVNUM) \
                            //`------------------------------------'  `------------------------------------'
    ),
 ...
 //|--------+--------+--------+--------+--------+--------|                      |--------+--------+--------+--------+--------+--------|
     _______,   GUI_A,   ALT_R,  CTRL_S,  SHFT_T,    KC_G,                           KC_M,  SHFT_N,  CTRL_E,   ALT_I,   GUI_O, _______,\
 //|--------+--------+--------+--------+--------+--------+---------.  ,---------+--------+--------+--------+--------+--------+--------|
...
// this is based on the handsdown ALT layout. swapped W and Z
 ...
 //`--------------------------+--------+--------+--------+---------|  |--------+--------+--------+--------+--------+-----------------'
    ...
    [_NAVNUM] = LAYOUT( \
 //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     _______, QWERT,   HNDALT, COLEMAK, _______, _______,                      _______, _______, _______, _______, _______, _______,\
 //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, KC_LBRC,    KC_7,    KC_8,    KC_9, KC_RBRC,                        kAGIN,   kUNDO,    kCUT,   kCOPY,   kPSTE, _______,\
 //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL,                      KC_CAPS, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______,\
 //|--------+--------+--------+--------+--------+--------+--------.  ,--------+--------+--------+--------+--------+--------+--------|
     _______,  KC_GRV,    KC_1,    KC_2,    KC_3, KC_BSLS,mBootLoad,    _______, KC_ASTG, KC_HOME, KC_PGDN, KC_PGUP,  KC_END, _______,\
 //`--------------------------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+-----------------'
                                _______,  KC_DOT,    KC_0, KC_MINS,     KC_ENT, KC_BSPC,  KC_DEL, _______ \
                            //`-----------------------------------'  `-----------------------------------'
    ),
